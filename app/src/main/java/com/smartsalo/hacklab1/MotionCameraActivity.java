...
import com.smartsalo.hacklab1.detection.AggregateLumaMotionDetection;
import com.smartsalo.hacklab1.detection.IMotionDetection;
import com.smartsalo.hacklab1.detection.LumaMotionDetection;
import com.smartsalo.hacklab1.detection.RgbMotionDetection;
...
public class MotionCameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_motion_camera);
    ...
    public void onResume() {
        ...
        if (inPreview){
            ...
            //  parameters.setPreviewFpsRange(3000, 3000);
            // parameters.setPreviewSize(320, 160);
    ...
    private SurfaceHolder.Callback surfaceCallback = new SurfaceHolder.Callback() {
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            try {
                ...
                Log.e("PreviewDemo-surfac", "Exception in setPreviewDisplay()", t);
            }
        }
    ...
    private final class SavePhotoTask extends AsyncTask<Bitmap, Integer, Integer> {
        ...
        private void save(String name, Bitmap bitmap) {
            uploadBitmap(bitmap.copy(bitmap.getConfig(),false));
    ...
    private void uploadBitmap(final Bitmap bitmap) {
        ...
        final  Bitmap bitmap1 = drawTextToBitmap(bitmap,currentTime);
        //getting the tag from the edittext
        final String tags = "tageja";

        //our custom volley request
        VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, "http://65.109.137.146:81/upload1",
    ...
    public Bitmap drawTextToBitmap(Bitmap bitmap,
        ...
        int x = 0;//0;(bitmap.getWidth() - bounds.width())/2;
        int y = 30;//(bitmap.getHeight() + bounds.height())/2;
